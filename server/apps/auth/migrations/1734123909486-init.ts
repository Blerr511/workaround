...
export class Init1734123909486 implements MigrationInterface {
    name = 'Init1734123909486'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "wr_user" ("uid" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying NOT NULL, "passwordHash" character varying NOT NULL, CONSTRAINT "PK_9159106cd59996eb5e8c4f60b16" PRIMARY KEY ("uid"))`);
